      ...
      <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
        ...
        <tr><td style="background:\${bgCard};padding:28px 32px 12px;">
          <p style="margin:0;font-size:15px;line-height:1.7;color:\${textMuted};font-style:italic;text-align:center;">
            \${introText || "Insights on leadership, team dynamics, and the 6 principles that help teams move from stagnation to transformation."}
          </p>
        </td></tr>

        <!-- HEADER IMAGE -->
        \${headerImage ? \`<tr><td style="background:\${bgCard};padding:16px 32px;">
        ...
        <tr><td style="background:\${bgCard};padding:20px 32px;">
          ...
          \${blogSummary ? \`<p style="margin:0 0 20px;font-size:15px;line-height:1.6;color:\${textMuted};">\${blogSummary}</p>\` : ""}
        </td></tr>
        ...
        <tr><td style="background:\${bgCard};padding:4px 32px 24px;">
          <table cellpadding="0" cellspacing="0">
            <tr><td style="background:\${teal};border-radius:8px;">
              <a href="\${ctaUrl}" style="display:inline-block;padding:14px 28px;color:#ffffff;text-decoration:none;font-weight:600;font-size:15px;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">\${ctaText}</a>
            </td></tr>
          </table>
        </td></tr>
        ...
        <tr><td style="background:\${bgCard};border-radius:12px;margin-top:8px;">
          <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e8e4e0;border-radius:12px;overflow:hidden;">
        ...
        <!-- FOOTER -->
        <tr><td>
          <table width="100%" cellpadding="0" cellspacing="0" style="background:\${bgCard};border-radius:0 0 16px 16px;border:1px solid #e8e4e0;border-top:none;">
            <tr><td style="padding:24px 32px;text-align:center;">
              ...
              <p style="margin:0 0 20px;font-size:13px;">
                ...
                <span style="color:#ccc;"> | </span>
                <a href="https://spiralingup.works/meeting" style="color:\${coral};text-decoration:none;font-weight:500;">Book a Meeting</a>
              </p>
              ...
              <p style="margin:0;font-size:11px;color:\${textLight};">© \${new Date().getFullYear()} SPIRAL UP™. All rights reserved.</p>
            </td></tr>
          </table>
        </td></tr>
